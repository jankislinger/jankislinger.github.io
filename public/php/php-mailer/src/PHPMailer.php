...
class PHPMailer
{
     ...
     * @param string      $header  Additional HeaderComponent(s)
     ...
     * @param string|null $value HeaderComponent value
     */
     ...
     *
     * @param string $signHeader HeaderComponent
     *
     * @return string
     */
     ...
     *
     * @param string $headers_line HeaderComponent lines
     * @param string $subject      Subject
